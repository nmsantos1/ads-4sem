 ...
 */
package br.com.aplcurso.controller.cidade;

import br.com.aplcurso.dao.CidadeDAO;
...
public class CidadeListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("cidade", dao.listar());
            request.getRequestDispatcher("/cadastros/cidade/cidade.jsp").forward(request, response);
        } catch (Exception ex) {
            
            System.out.println("Problemas no Servlet ao Listar" + " Cidades! Erro: "+ex.getMessage());
            ex.printStackTrace();
        }
    }
